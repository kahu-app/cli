...
build: install ## Build kahu-cli and kahu-cli.phar
	@box compile
...
phpstan: install ## Run phpstan static code analysis
	@php -dopcache.enable=0 ./vendor/bin/phpstan analyse --level=max --autoload-file=./vendor/autoload.php ./bin ./config ./src
